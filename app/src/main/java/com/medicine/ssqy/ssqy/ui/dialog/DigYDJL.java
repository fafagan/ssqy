 ...
 */
public class DigYDJL extends Dialog implements View.OnClickListener {
    ...
    public DigYDJL(final Context context) {
        super(context);
        mContext=context;
        ...
        mTvTitleJbgl.setText("请填写您今天的运动情况：");
    }
    ...
    public void onClick(View v) {
        ...
        if (StringEmptyUtil.isEmpty(string)) {
            Toast.makeText(mContext, "请填写运动情况再保存！", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (mIsUpdateMode) {
            ...
            mNetForJson.addParam("recordtype", URLConstant.RECORD_TYPE_YD);
