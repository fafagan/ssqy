...
public class CourseAudioEntity {
    ...
    public List<AudioCourseDataEntity> getCourseData() {
        return audioCourseData;
    }
    
    public void setCourseData(List<AudioCourseDataEntity> audioCourseData) {
        this.audioCourseData = audioCourseData;
    }
    
    public static class AudioCourseDataEntity {
